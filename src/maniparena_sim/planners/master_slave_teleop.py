...
from maniparena_sim.embodiment.teleop_devices.bimanual_master import BimanualMasterCfg, BimanualMasterTeleop
from maniparena_sim.embodiment.teleop_devices.keyboard import _get_expected_action_dim, _map_action_dim
...
class MasterSlaveTeleopPlanner(TeleopPlanner):
    ...
    def _init_device(self, env: Any) -> None:
        ...
        self._master_controller = BimanualMasterTeleop(cfg)
