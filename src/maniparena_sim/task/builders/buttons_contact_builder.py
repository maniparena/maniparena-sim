...
from maniparena_sim.task.buttons_contact import ButtonsContactTask, ButtonsContactTerminationsCfg
from maniparena_sim.task.utils import build_default_events_cfg, find_assets_by_tag
from maniparena_sim.terms.terminations import contacts_all_buttons_once
