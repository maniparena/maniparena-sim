...
from maniparena_sim.terms.recorders.dataset_handlers.bimanual_lerobot.constants import (
...
from maniparena_sim.terms.recorders.dataset_handlers.utils import (
    feature_stats,
    nested_get,
    read_json,
    read_jsonl,
...
from maniparena_sim.utils.math_utils import quat_xyzw_to_euler_xyz
...
class BimanualLeRobotDatasetFileHandler(DatasetFileHandlerBase):
    ...
    def _initialize_roots(self) -> None:
        if not self._output_layout:
            from maniparena_sim.terms.recorders.dataset_handlers.bimanual_lerobot.helpers import resolve_bimanual_lerobot_dataset_layout
