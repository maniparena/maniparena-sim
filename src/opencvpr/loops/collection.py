...
from opencvpr.planners.keyboard_teleop import KeyboardTeleopPlanner
from opencvpr.planners.master_slave_teleop import MasterSlaveTeleopPlanner
from opencvpr.planners.planner_base import PlannerBase
...
def _resolve_dataset_export(environment, env_name: str, prompt: str, planner: PlannerBase, config: CollectConfig):
    if config.format == "hdf5":
        return None, {}, []
    if config.format != "ex001_6r_lerobot":
        return None, {}, []
