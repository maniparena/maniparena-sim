...
SDK 合同见 `src/maniparena_sim/ros/ex001_sdk_topics.py`。禁止 `/mock_robot_interface/*`、`/chassis/odom`、`/manaenv/*`。
...
| `/left_gripper/joint_states` / `/right_gripper/joint_states` | `JointState`（SDK 0–4.5） |
...
| `/left_gripper_controller/commands` | `Float64MultiArray`（SDK 0–4.5） |
